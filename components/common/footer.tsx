...
const Footer = () => {
  const contactInfo = [
    ...
    {
      icon: <div className="bg-white rounded-full p-0.5"><div className="bg-secondary rounded-full p-1"><Mail className="w-5 h-5 text-white" /></div></div>,
      title: "Mail Us",
      subtitle: "info@example.com",
    },
    {
      icon: <div className="bg-white rounded-full p-0.5"><div className="bg-secondary rounded-full p-1"><Phone className="w-5 h-5 text-white" /></div></div>,
      title: "Call Us",
